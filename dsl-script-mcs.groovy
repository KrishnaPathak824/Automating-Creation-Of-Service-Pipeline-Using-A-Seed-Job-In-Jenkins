cat dsl/create_service_pipeline.groovy 
...
folder('services-mcs') { displayName('MCS') }

pipelineJob("services-mcs/${serviceName}") {
...
SVC_DIR="\${APP_ROOT}/backend/mcs/${serviceName}"
...
# Update repo in the service dir
cd "\${SVC_DIR}"
...
cd /root/kubernetes/application/BACKEND
sudo cp /root/kubernetes/application/BACK/${imageName}.yml /root/kubernetes/application/BACKEND/
